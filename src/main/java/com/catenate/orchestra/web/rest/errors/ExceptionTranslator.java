...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.catenate.orchestra.service.EmailAlreadyUsedException ||
            ex instanceof com.catenate.orchestra.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.catenate.orchestra.service.InvalidPasswordException
