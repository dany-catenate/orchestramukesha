...
import { EntityArrayResponseType, InsegnanteService } from '../service/insegnante.service';
...
export class InsegnanteComponent implements OnInit {
  ...
  trackId = (_index: number, item: IInsegnante): number => this.insegnanteService.getInsegnanteIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.insegnantes = this.refineData(dataFromBody);
  }

  protected refineData(data: IInsegnante[]): IInsegnante[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IInsegnante[] | null): IInsegnante[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.insegnanteService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
